...
# load dataset
dataframe = read_csv("/Users/agambo/deep_learning/dpl_toolbox/data/ionosphere.csv", header=None)
...
model.compile(loss='binary_crossentropy', optimizer=sgd, metrics=['accuracy']) # learning schedule callback
